    ...
    <section className="flex flex-col md:flex-row items-center md:items-start gap-12 mb-16">
      ...
      <div className="flex flex-col items-center md:items-start space-y-4">
        ...
        <p className="max-w-2xl text-center md:text-left text-muted-foreground">
          ...
          <br/>
          I specialize in data visualization, statistical analysis, and predictive modeling, using tools like Python, SQL, Tableau, and Power BI to derive insights and drive data-driven decisions. Open to full-time opportunities in data analytics, business intelligence, and data science. Find my resume <a href="/resume2026.pdf" target="_blank" rel="noopener noreferrer" className="text-primary underline">here</a>.
        </p>
